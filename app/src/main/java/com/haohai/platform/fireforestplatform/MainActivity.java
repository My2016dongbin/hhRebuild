...
//                        versionNameService = "V2.2.2";
                        ...
                        EventBus.getDefault().post(new Update(apkUrl,200000,Integer.parseInt(versionService),versionNameService.replace("V",""),"68919BF998C29DA3F5BD2C0346281AC0",Integer.parseInt(isForce),"1、优化细节和体验，更加稳定\n2、" + versionDescription + "\n"));
