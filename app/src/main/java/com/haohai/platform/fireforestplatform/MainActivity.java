...
import com.haohai.platform.fireforestplatform.utils.DahuaTokenInfoDemo;
...
public class MainActivity extends BaseLiveActivity<ActivityMainBinding, MainViewModel> implements BottomNavigationBar.OnTabSelectedListener{
    ...
    private void getDaHuaToken(Map<String, Object> paramsMap) {
        ...
        HhLog.e( "getDaHuaToken: " + gson.toJson(dahuaToken) );
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                HhLog.e( "onSuccess: result " + result );
                try {
                    ...
                    if(jsonObject.getString("msg")!=null&&jsonObject.getString("msg").contains("操作成功")){
                        ...
                        HhLog.e( "onSuccess: CommonData " + CommonData.daHuaTokenStr + "," + CommonData.daHuaId );
    ...
    private void testSubList(Map<String, Object> paramsMap) {
        ...
        HhLog.e( "testSubList: " + gson.toJson(dahuaTokenInfo) );
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                HhLog.e( "onSuccess:testSubList result " + result );
                try {
                    JSONObject object = new JSONObject(result);
    ...
    private void testSubToken(Map<String, Object> paramsMap) {
        ...
        params.setBodyContent(gson.toJson(dahuaTokenInfo));
        HhLog.e("testSubToken: " + gson.toJson(dahuaTokenInfo) );
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                HhLog.e("onSuccess:testSubToken result " + result );
                try {
                    JSONObject object = new JSONObject(result);
                    JSONObject results = object.getJSONObject("result");
                    JSONObject data = results.getJSONObject("data");
    ...
    private void testSubDeviceList(Map<String, Object> paramsMap) {
        ...
        params.setBodyContent(gson.toJson(dahuaTokenInfo));
        HhLog.e( "testSubDeviceList: " + gson.toJson(dahuaTokenInfo) );
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                HhLog.e("onSuccess:testSubDeviceList result " + result );
                try {
                    JSONObject object = new JSONObject(result);
                    JSONObject results = object.getJSONObject("result");
                    JSONObject data = results.getJSONObject("data");
                    JSONArray deviceList = data.getJSONArray("deviceList");
                    HhLog.e("onSuccess:testSubDeviceList result length " + deviceList.length() );
                    HhLog.e("onSuccess:testSubDeviceList result length contains " + result.contains("7K07A47PAG58E2F") );
                    HhLog.e("onSuccess:testSubDeviceList result length contains " + result.contains("南昌村坟地") );
                    if(CommonData.deviceSubList==null){
                        CommonData.deviceSubList = new JSONArray();
                    }
                    for (int i = 0; i < deviceList.length(); i++) {
                        JSONObject obj = (JSONObject) deviceList.get(i);
                        CommonData.deviceSubList.put(obj);
                    }
