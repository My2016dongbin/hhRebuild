...
public class URLConstant {
    ...
    public static final String BASE_PATH = "http://117.132.5.139:19066/";//Release
...
//    public static final String POST_MAP_SATELLITE = BASE_PATH + "fire/api/satelliteFirealarm/list";//卫星报警数据
    ...
    //临沂综合检查相关
    public static final String POST_RES_TYPE_LIST = BASE_PATH +"resource/api/resourceList/list";//获取资源类型列表
    public static final String GET_RES_LIST = BASE_PATH +"resource/api/";//获取资源列表left
    public static final String GET_USER_LIST = BASE_PATH +"auth/api/auth/user/list";//获取人员列表
    public static final String POST_COMPREHENSIVE_SUBMIT = BASE_PATH +"resource/api/comprehensiveInspection/installCheckPlan";//"resource/api/plan/installCheckPlan";//综合检查提交
    public static final String POST_COMPREHENSIVE_LIST = BASE_PATH +"resource/api/comprehensiveInspection/viewTheComprehensivePlan?isAndroid=1";//综合检查列表
    public static final String POST_COMPREHENSIVE_ZZ = BASE_PATH +"resource/api/comprehensiveInspection/changeResource";//综合检查整治提交
    public static final String POST_COMPREHENSIVE_CK = BASE_PATH +"resource/api/comprehensiveInspection/saveResourceItem";//综合检查审核提交
