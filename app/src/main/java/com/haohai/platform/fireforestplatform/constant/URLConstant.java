...
//    public static final String GET_LOGIN = BASE_PATH + "auth/oauth/token";//登录
    ...
    public static final String POST_MAP_ONE_BODY2 = BASE_PATH + "fire/api/monitorFirealarm/getFirePage?type=appInternet";//一体机报警数据
    public static final String POST_MAP_ONE_BODY_DETAIL = BASE_PATH + "fire/api/monitorFirealarm/getMonitorAlarmById";//一体机报警详情
...
//    public static final String GET_FIRE_COUNT = BASE_PATH + "fire/api/Statistic/getLeaderFireAlarmList";//"fire/api/Statistic/getLatestFireAlarmList";//查询报警数量
    public static final String GET_FIRE_COUNT = BASE_PATH + "fire/api/monitorFirealarm/getCountByDay";//查询报警数量
...
//    public static final String GET_VIDEO_LIVE_URL = BASE_PATH +"resource/api/mediaKit/getLiveUrl";//视频流 /*"cameraId",gridCamera.getId(),"manufacturer","2","streamType","2","protocolType","rtsp"*/
    ...
    public static final String POST_TASK_LIST = BASE_PATH +"oa/api/taskManagement/page";//任务列表
