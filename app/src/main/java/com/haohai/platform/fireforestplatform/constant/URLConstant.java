...
//    public static final String BASE_PATH = "http://172.16.50.223:8444/";//"http://192.168.1.34:8012/";//Release 本地
    public static final String BASE_PATH = "http://39.153.161.212:28011/";//Release-穿透
    ...
    public static final String POST_PICTURE = /*"http://117.132..139:8011/"*/ BASE_PATH + "oa/api/workReport/fileUploadAnByNotToken";//上传图片
    ...
    public static final String GET_CONTROL_GB = BASE_PATH + "resource/api/liveVideo/controlGB";//视频设备控制-国标
    ...
    ///鄂尔多斯马牛羊识别
    public static final String POST_FILE_UPLOAD = BASE_PATH + "fire/api/fireArchives/fileUpload";//文件上传
    public static final String POST_IDENTIFY_LIST = BASE_PATH + "fire/api/monitorAlgorithmAlarm/page";//马牛羊识别列表
    /* 识别列表
     * {
     *     "limit": 15,
     *     "page": 1,
    ...
    public static final String GET_IDENTIFY_DETAIL = BASE_PATH + "fire/api/monitorAlgorithmAlarm";//马牛羊识别详情 ?id=2b32b614-24fd-43e9-9d4a-b99de09b825b
    public static final String PUT_IDENTIFY_HANDLE = BASE_PATH + "fire/api/monitorAlgorithmAlarm/updateMonitorAlgorithmStates";//马牛羊识别处理 ?fireId=2b32b614-24fd-43e9-9d4a-b99de09b825b&isReal=0&isTrueNote=这是识别处理备注
    public static final String POST_IDENTIFY_CHECK = BASE_PATH + "fire/api/monitorAlgorithmAlarm/dispose";//马牛羊识别督导
    /*
    {
     ...
     */
    public static final String POST_HANDLE_LIST = BASE_PATH + "fire/api/monitorAlgorithmAlarm/page";//马牛羊处置列表
    /* 处置列表
     * {
     *     "limit": 15,
     *     "page": 1,
     ...
     * }
     */
    public static final String GET_HANDLE_DETAIL = BASE_PATH + "fire/api/monitorAlgorithmAlarm";//马牛羊处置详情 ?id=2b32b614-24fd-43e9-9d4a-b99de09b825b
    public static final String POST_HANDLE_UPLOAD = BASE_PATH + "fire/api/monitorAlgorithmAlarm/situationReport";//马牛羊处置上报
    /*
    {
      "algorithmAlarmId": "3c872224-f527-4f54-8632-d574adb655ca",
      "pic1Path": "",
      "pic2Path": "",
      "pic3Path": "",
      "content": "这是处置内容"
     ...
     */
    public static final String POST_CHECK_LIST = BASE_PATH + "fire/api/monitorAlgorithmAlarm/supervisePage";//马牛羊督导列表
    /* 督导列表
    {
        "limit": 15,
        "page": 1,
        "dto": {
            ...
            "alarmType": "",
            "ip": 0,
            "superviseFlag": 1,//1待核实 2已核实
        },
        "isAndroid": 0
    }
     */
    public static final String GET_CHECK_DETAIL = BASE_PATH + "fire/api/monitorAlgorithmAlarm";//马牛羊督导详情 ?id=2b32b614-24fd-43e9-9d4a-b99de09b825b
    public static final String POST_CHECK_CONFIRM = BASE_PATH + "fire/api/monitorAlgorithmAlarm/disposeVerify";//马牛羊督导核实回复
    /*
    {
        "algorithmAlarmId": "c4b7596b-c1a3-44e5-af66-cc09947045be",
        "pic1Path": "",
        "pic2Path": "",
        "pic3Path": "",
        "content": "这是督导核实回复内容"
     ...
     */
    public static final String POST_IDENTIFY_COUNT = BASE_PATH + "fire/api/monitorAlgorithmAlarm/identify/stat";//主页识别数量统计
    public static final String POST_CHECK_COUNT = BASE_PATH + "fire/api/monitorAlgorithmAlarm/verify/stat";//主页督导数量统计
