package com.haohai.platform.fireforestplatform.old.calendar.group;

import android.content.Context;

import com.haohai.platform.fireforestplatform.old.calendar.base.adapter.BaseRecyclerAdapter;
...
public abstract class GroupRecyclerAdapter<Parent, Child> extends BaseRecyclerAdapter<Child> {
    private final LinkedHashMap<Parent, List<Child>> mGroups;
    private final List<Parent> mGroupTitles;
