...
public class AddSearchCheck {
    ...
    public AddSearchCheck() {
    }

    public String getegulationTime() {
        return regulationTime;
    }

    public void setRegulationTime(String gegulationTime) {
        this.regulationTime = gegulationTime;
    }
