...
public class CommonPermission {
    ...
    public static final String APP_CHECK = "app-application-btn-check";//首页-综合检查
    public static final String APP_DAILY_CHECK = "app-application-btn-check_daily";//首页-日常检查
    public static final String APP_RESOURCE_SEARCH = "app-application-btn-resource_search";//首页-资源检索
