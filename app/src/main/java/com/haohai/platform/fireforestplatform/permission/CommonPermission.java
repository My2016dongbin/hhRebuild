package com.haohai.platform.fireforestplatform.permission;
...
public class CommonPermission {
    ...
    public static final String APP_UPLOAD = "app-application-btn-fire";//首页-事件上报
    ...
    public static final String APP_WORKER = "app-application-btn-worker";//首页-值班
    ...
    public static final String APP_RH = "app-application-btn-rh";//首页-融合通信
    ...
    public static final String APP_CONTACTS = "app-application-btn-contacts";//首页-通讯录
