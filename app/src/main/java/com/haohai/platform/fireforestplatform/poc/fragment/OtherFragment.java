package com.haohai.platform.fireforestplatform.poc.fragment;
...
import com.haohai.platform.fireforestplatform.poc.activity.AvActivity;
import com.haohai.platform.fireforestplatform.poc.activity.ChatMessageActivity;
import com.haohai.platform.fireforestplatform.poc.activity.MapActivity;
...
public class OtherFragment extends Fragment {
    ...
    private void addSetGpsNotIgnoreRepeatedFunc() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                boolean gpsNotIgnoreRepeated = HhApplication.PocEngineConfigureProducer.getConfig().gpsNotIgnoreRepeated;
                gpsNotIgnoreRepeated = !gpsNotIgnoreRepeated;
                pocEngine.setGpsNotIgnoreRepeated(gpsNotIgnoreRepeated);
                HhApplication.PocEngineConfigureProducer.getConfig().gpsNotIgnoreRepeated = gpsNotIgnoreRepeated;
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(getContext()).setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        HhApplication.PocEngineConfigureProducer.getConfig().gpsReportInterval = interval;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(getContext()).setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        int gpsMode = which;
                        HhApplication.PocEngineConfigureProducer.getConfig().gpsMode = gpsMode;
