...
import com.haohai.platform.fireforestplatform.databinding.ActivityComprehensiveCkBinding;
import com.haohai.platform.fireforestplatform.ui.bean.CheckImage;
import com.haohai.platform.fireforestplatform.ui.viewmodel.ComprehensiveCKViewModel;
...
public class ComprehensiveCKActivity extends BaseLiveActivity<ActivityComprehensiveCkBinding, ComprehensiveCKViewModel>{
    ...
    private void init_() {
        binding.topBar.title.setText("综合检查审核");
        updateStatus();
    ...
    @Override
    protected ActivityComprehensiveCkBinding dataBinding() {
        return DataBindingUtil.setContentView(this,R.layout.activity_comprehensive_ck);
    }
    ...
    @Override
    public ComprehensiveCKViewModel obtainViewModel() {
        return ViewModelProviders.of(this, ViewModelFactory.getInstance()).get(ComprehensiveCKViewModel.class);
    }
        ...
        for (int m = 0; m < checkImages.size(); m++) {
            ...
            if (checkImage.getUri() != null) {
                ...
                icon.setOnClickListener(v -> {
                    ...
                    String content = "";     //放评论
                    ImagePagerUtil imagePagerUtil = new ImagePagerUtil(ComprehensiveCKActivity.this, picList);
                    ...
                    rxPermissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA)
                            .subscribe(new Observer<Boolean>() {
                                ...
                                public void onNext(Boolean aBoolean) {
                                    ...
                                    Matisse.from(ComprehensiveCKActivity.this)
