...
public class SatelliteListDialog extends Dialog implements SatelliteFireViewBinder.OnItemClickListener, SatelliteFilterDialog.SatelliteFilterListener {
    ...
    private SatelliteFilterDialog filterDialog;
    ...
    private void bind_() {
        binding.filterLinear.setOnClickListener(v -> {
            hide();
    ...
    private void initFilterDialog() {
        filterDialog = new SatelliteFilterDialog(context, R.style.ActionSheetDialogStyle);
    ...
    @Override
    public void onSatelliteFilterRefresh() {

    }

    @Override
    public void onSatelliteFilterResult(SatelliteFilter filter) {
        filterState = filter.getFilterState();

        updateFilterData();
        dialogListener.onSatelliteSearchRefresh(filter);

        show();
    }

    @Override
    public void onSatelliteFilterDismiss() {
        show();
    }
    ...
    public interface SatelliteDialogListener{
        ...
        void onSatelliteSearchRefresh(SatelliteFilter filter);
