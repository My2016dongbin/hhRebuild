...
import com.haohai.platform.fireforestplatform.databinding.FgHandle;
...
import com.haohai.platform.fireforestplatform.ui.multitype.HandleViewBinder;
import com.haohai.platform.fireforestplatform.ui.viewmodel.FgHandleViewModel;
...
public class HandleFragment extends BaseFragment<FgHandle, FgHandleViewModel> implements HandleViewBinder.OnItemClickListener {

    public static HandleFragment newInstance(String param1) {
    ...
    @Override
    public FgHandleViewModel obtainViewModel() {
        return ViewModelProviders.of(this, ViewModelFactory.getInstance()).get(FgHandleViewModel.class);
    }
    ...
    private void init_() {
        ...
        HandleViewBinder messageViewBinder = new HandleViewBinder(requireActivity());
        messageViewBinder.setListener(this);
        obtainViewModel().adapter.register(Handle.class, messageViewBinder);
    ...
    public void onItemClick(Handle message) {
        Intent intent = new Intent(requireActivity(), HandleDetailActivity.class);
        intent.putExtra("id",message.getId());
        startActivity(intent);
    }

    private void remove_(Handle message) {
