 ...
 */
public class DangerViewBinder extends ItemViewProvider<Danger, DangerViewBinder.ViewHolder> {
    public Context context;
    public DangerViewBinder(Context context) {
    ...
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        ViewDataBinding dataBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
                R.layout.item_danger, parent, false);
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder viewHolder, @NonNull final Danger message) {
        ...
        ItemDangerBinding binding = (ItemDangerBinding) viewHolder.getBinding();
...
//                    .into(binding.status);
    ...
    public interface OnItemClickListener{
        void onItemClick(Danger message);
        void onEditClick(Danger message);
        void onDeleteClick(Danger message);
    }
}
