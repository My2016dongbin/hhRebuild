...
import com.haohai.platform.fireforestplatform.databinding.ItemEmergencyBinding;
 ...
 */
public class EmergencyViewBinder extends ItemViewProvider<Emergency, EmergencyViewBinder.ViewHolder> {
    public Context context;
    public EmergencyViewBinder(Context context) {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder viewHolder, @NonNull final Emergency message) {

        ItemEmergencyBinding binding = (ItemEmergencyBinding) viewHolder.getBinding();
        ...
        if("1".equals(message.getHandleStatus())){
            ...
            binding.textStatus.setText("处置完毕");
    ...
    public interface OnItemClickListener{
        void onItemClick(Emergency message);
    }
}
