...
public class SheQu {
    ...
    public static class Geometry{
        ...
        public Geometry(List<ArrayList<ArrayList<Double>>> coordinates, String type) {
            this.coordinates = coordinates;
            this.type = type;
        }

        public List<ArrayList<ArrayList<Double>>> getCoordinates() {
            return coordinates;
        }

        public void setCoordinates(List<ArrayList<ArrayList<Double>>> coordinates) {
            this.coordinates = coordinates;
        }
