    ...
    public void getStream(String cameraId, String monitorId, String channelId, String deviceId) {
        ...
        HhHttp.get().url(URLConstant.GET_VIDEO_LIVE_URL)
                        ...
                        public void onSuccess(String response, int id) {
                            HhLog.e("getStream cameraId " + cameraId);
                            HhLog.e("getStream monitorId " + monitorId);
                            HhLog.e("getStream channelId " + channelId);
                                ...
                                if (data.length() > 0) {
                                    ...
                                    new Handler().postDelayed(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            CommonData.videoCtrlDeviceId = deviceId;
