...
public class SafetyViewModel extends BaseViewModel {
    ...
    public List<Safety> messageList = new ArrayList<>();
    ...
    public void postData(boolean load){
        ...
        HhHttp.get()
                ...
                .addParams("hiddenType","Rectification")//风险隐患NatuRiskManage 安全生产Rectification
                ...
                .execute(new LoggedInStringCallback(this,context) {
                    ...
                    public void onSuccess(String response, int id) {
                        ...
                        try {
                            ...
                            if(data.length()>0){
                                messageList = new Gson().fromJson(String.valueOf(data), new TypeToken<List<Safety>>() {
                                }.getType());
                            }
                            updateData();
