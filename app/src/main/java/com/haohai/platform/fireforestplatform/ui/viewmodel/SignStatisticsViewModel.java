...
public class SignStatisticsViewModel extends BaseViewModel {
    ...
    public void postData(){
        ...
        if(!(boolean)(SPUtils.get(context,SPValue.manager,false))){
            ids.add((String) SPUtils.get(context,SPValue.id,""));
        }
        String content = new Gson().toJson(new CommonParams(limit,page,new CommonParams.Dto(date.toString(),endDate.toString(), ids,attendanceStatus)));
        HhHttp.postString()
