...
public class CommonData {
    ...
    public static final int CHECK_REQUEST_CODE = 815;
    ...
    public static List<CheckResource> checkResourceList = new ArrayList<>();
    ...
    //临沂综合检查
    public static ComprehensiveList comprehensiveList;
    public static ComprehensiveList.PlanResourceDTOSBean comprehensiveRes;
}
